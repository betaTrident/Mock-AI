...
export default function InterviewPage() {
  ...
  const initializeInterview = async (forceNewQuestions = false) => {
    ...
    try {
      ...
      interviewQuestions.forEach((question, index) => {
        const questionRef = doc(collection(db, 'interviews', interviewId, 'questions'));
  ...
  const endInterview = async () => {
    ...
    // You might want to perform any cleanup or final data saving here
    setTimeout(() => {
      navigate('/feedback');
    }, 2000);
  };
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-700">
                    Click on Record Answer when you're ready to answer the question. 
                    Your answer will be automatically saved when you finish speaking.
                  </p>
                </div>
