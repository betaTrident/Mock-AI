...
export async function saveAnswer(interviewId, questionIndex, answer, question) {
  const auth = getAuth();
  ...
  try {
    console.log('Attempting to save answer for interview:', interviewId);
    ...
    const answersRef = collection(interviewRef, 'answers');
