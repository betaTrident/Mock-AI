...
export async function generateAndStoreFeedback(interviewId, questionId, question, userAnswer, expectedAnswer) {
  try {
    ...
    const answerRef = doc(db, 'interviews', interviewId, 'answers', questionId);
